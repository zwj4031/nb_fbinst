...
static const uint8_t grub4dos_mbr_code[] = {
    ,
...
static const uint8_t grub2_mbr_code[] = {
    0xeb, 0x48, 0x90, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static const uint8_t syslinux_mbr_code[] = {
    ,
...
static const uint8_t plop_mbr_code[] = {
    0xfa, 0x33, 0xc0, 0x8e, 0xd0, 0xbc, 0x00, 0x7c, 0x8b, 0xf4, 0x50, 0x07, 0x50, 0x1f, 0xfb, 0xfc,
    ...
    0x55, 0xaa, 0x75, 0xc7, 0x8f, 0xf5, 0xea, 0x00, 0x7c, 0x00, 0x00, 0x49, 0x6e, 0x76, 0x61, 0x6c,
...
static int write_pbr_data(struct fbfs_disk *disk, uint32_t part_start, uint32_t offset, uint32_t len, const uint8_t *data) {
	uint8_t buf[8192];
	uint32_t start_sec = offset / FBFS_SECTOR_SIZE;
	uint32_t end_sec = (offset + len + FBFS_SECTOR_SIZE - 1) / FBFS_SECTOR_SIZE;
	uint32_t num_secs = end_sec - start_sec;

	if (fbfs_disk_read(disk, part_start + start_sec, buf, num_secs) != FBFS_OK)
		return FBFS_ERR_READ;

	memcpy(buf + (offset % FBFS_SECTOR_SIZE), data, len);

	if (fbfs_disk_write(disk, part_start + start_sec, buf, num_secs) != FBFS_OK)
		return FBFS_ERR_WRITE;

	return FBFS_OK;
}

static void update_exfat_checksum(struct fbfs_disk *disk, uint32_t part_start) {
	uint8_t buf[11 * FBFS_SECTOR_SIZE];
	uint32_t checksum = 0;
	int i;
	if (fbfs_disk_read(disk, part_start, buf, 11) == FBFS_OK) {
		for (i = 0; i < 11 * FBFS_SECTOR_SIZE; i++) {
			if (i == 106 || i == 107 || i == 112) continue;
			checksum = ((checksum << 31) | (checksum >> 1)) + buf[i];
		}
		uint8_t cbuf[FBFS_SECTOR_SIZE];
		for (i = 0; i < FBFS_SECTOR_SIZE / 4; i++) {
			((uint32_t*)cbuf)[i] = checksum;
		}
		fbfs_disk_write(disk, part_start + 11, cbuf, 1);
	}
}
...
int fbfs_write_mbr(struct fbfs_disk *disk, const char *type)
{
	...
	is_gpt = (sector0[0x1be + 4] == 0xee);

	if (!fbfs_strcasecmp(type, "nt60") || !fbfs_strcasecmp(type, "nt6.x") || !fbfs_strcasecmp(type, "nt6")) {
		memcpy(sector0, nt6_mbr, 440);
	} 
	else if (!fbfs_strcasecmp(type, "nt52") || !fbfs_strcasecmp(type, "nt5.x") || !fbfs_strcasecmp(type, "nt5")) {
		memcpy(sector0, nt5_mbr, 440);
	} 
	else if (!fbfs_strcasecmp(type, "grub4dos") || !fbfs_strcasecmp(type, "g4d") || !fbfs_strcasecmp(type, "grub")) {
		uint8_t temp_buf[FBFS_SECTOR_SIZE];
		uint32_t num_sectors;
		uint32_t i;

		if (is_gpt) {
			memset(sector0, 0, 440);
			memcpy(sector0, grldr_gpt, sizeof(grldr_gpt));
		} else {
			memcpy(sector0, grldr_mbr, 440);
		}
		sector0[0x1fe] = 0x55;
		sector0[0x1ff] = 0xaa;
		if (fbfs_disk_write(disk, 0, sector0, 1) != FBFS_OK)
		...
		num_sectors = sizeof(grldr_mbr) / FBFS_SECTOR_SIZE;
		for (i = 1; i < num_sectors; i++) {
			memset(temp_buf, 0, FBFS_SECTOR_SIZE);
			memcpy(temp_buf, grldr_mbr + i * FBFS_SECTOR_SIZE, FBFS_SECTOR_SIZE);
			if (fbfs_disk_write(disk, i, temp_buf, 1) != FBFS_OK)
				return FBFS_ERR_WRITE;
		}
		return FBFS_OK;
	} 
	else if (!fbfs_strcasecmp(type, "syslinux") || !fbfs_strcasecmp(type, "sys")) {
		if (is_gpt)
			memcpy(sector0, syslinux_gpt_mbr, 440);
		else
			memcpy(sector0, syslinux_mbr, 440);
	} 
	else if (!fbfs_strcasecmp(type, "rufus")) {
		memcpy(sector0, rufus_mbr, 440);
	}
	else if (!fbfs_strcasecmp(type, "ultraiso") || !fbfs_strcasecmp(type, "ui")) {
		memcpy(sector0, ultraiso_hdd, 440);
	}
	else if (!fbfs_strcasecmp(type, "wee")) {
		uint8_t temp_buf[FBFS_SECTOR_SIZE];
		uint32_t wee_rem_sectors;
		uint32_t i;

		memcpy(sector0, wee_mbr, 440);
		sector0[0x1fe] = 0x55;
		sector0[0x1ff] = 0xaa;
		if (fbfs_disk_write(disk, 0, sector0, 1) != FBFS_OK)
			return FBFS_ERR_WRITE;
		...
		memset(temp_buf, 0, FBFS_SECTOR_SIZE);
		memcpy(temp_buf, nt6_mbr, 440);
		memcpy(temp_buf + 510, wee_mbr + 510, 2);
		if (fbfs_disk_write(disk, 1, temp_buf, 1) != FBFS_OK)
			return FBFS_ERR_WRITE;

		wee_rem_sectors = sizeof(wee_mbr) / FBFS_SECTOR_SIZE;
		for (i = 2; i < wee_rem_sectors; i++) {
			memset(temp_buf, 0, FBFS_SECTOR_SIZE);
			memcpy(temp_buf, wee_mbr + i * FBFS_SECTOR_SIZE, FBFS_SECTOR_SIZE);
			if (fbfs_disk_write(disk, i, temp_buf, 1) != FBFS_OK)
				return FBFS_ERR_WRITE;
		}
		return FBFS_OK;
		...
		return fbfs_set_error(FBFS_ERR_INVALID_ARGUMENT, "unsupported MBR type %s", type);
	}
...
int fbfs_write_pbr(struct fbfs_disk *disk, uint32_t slot, const char *type)
{
	...
	if (fbfs_disk_read(disk, part_start, sector0, 1) != FBFS_OK)
		return FBFS_ERR_READ;

	// 识别分区文件系统类型 (1=FAT16, 2=FAT32, 3=EXFAT, 4=NTFS)
	if (!strncmp((char *)(sector0 + 0x03), "NTFS", 4)) fs_type = 4;
	else if (!strncmp((char *)(sector0 + 0x03), "EXFAT", 5)) fs_type = 3;
	else if (!strncmp((char *)(sector0 + 0x52), "FAT32", 5)) fs_type = 2;
	else fs_type = 1;

	if (fbfs_disk_lock(disk) != FBFS_OK)
		return FBFS_ERR_LOCK;

	// 完全复刻 br 下的偏移量操作和校验更新
	if (!fbfs_strcasecmp(type, "bootmgr") || !fbfs_strcasecmp(type, "nt60") || !fbfs_strcasecmp(type, "nt6")) {
		if (fs_type == 1) {
			write_pbr_data(disk, part_start, 0, 3, bootmgr_pbr);
			write_pbr_data(disk, part_start, 0x3e, 0x200 - 0x3e, bootmgr_pbr + 0x3e);
		} else if (fs_type == 2) {
			write_pbr_data(disk, part_start, 0, 3, bootmgr_pbr + 0x200);
			write_pbr_data(disk, part_start, 0x5a, 0x400 - 0x5a, bootmgr_pbr + 0x200 + 0x5a);
		} else if (fs_type == 3) {
			write_pbr_data(disk, part_start, 0, 3, bootmgr_pbr + 0x600);
			write_pbr_data(disk, part_start, 0x78, 0x600 - 0x78, bootmgr_pbr + 0x600 + 0x78);
			update_exfat_checksum(disk, part_start);
		} else if (fs_type == 4) {
			write_pbr_data(disk, part_start, 0, 3, bootmgr_pbr + 0xc00);
			write_pbr_data(disk, part_start, 0x54, 0x1400 - 0x54, bootmgr_pbr + 0xc00 + 0x54);
		}
	} else if (!fbfs_strcasecmp(type, "ntldr") || !fbfs_strcasecmp(type, "nt52") || !fbfs_strcasecmp(type, "nt5")) {
		if (fs_type == 1) {
			write_pbr_data(disk, part_start, 0, 3, ntldr_pbr);
			write_pbr_data(disk, part_start, 0x3e, 0x200 - 0x3e, ntldr_pbr + 0x3e);
		} else if (fs_type == 2) {
			write_pbr_data(disk, part_start, 0, 3, ntldr_pbr + 0x200);
			write_pbr_data(disk, part_start, 0x5a, 0x400 - 0x5a, ntldr_pbr + 0x200 + 0x5a);
		} else if (fs_type == 4) {
			write_pbr_data(disk, part_start, 0, 3, ntldr_pbr + 0x600);
			write_pbr_data(disk, part_start, 0x54, 0xe00 - 0x54, ntldr_pbr + 0x600 + 0x54);
		} else {
			return fbfs_set_error(FBFS_ERR_UNSUPPORTED, "NT5 PBR does not support exFAT");
		}
	} else if (!fbfs_strcasecmp(type, "grub4dos") || !fbfs_strcasecmp(type, "g4d") || !fbfs_strcasecmp(type, "grub")) {
		uint8_t options[5] = {'G', 'R', 'L', 'D', 'R'};
		if (fs_type == 1) {
			write_pbr_data(disk, part_start, 0, 3, grldr_pbr + 0x200);
			write_pbr_data(disk, part_start, 0x3e, 0x200 - 0x3e, grldr_pbr + 0x200 + 0x3e);
			write_pbr_data(disk, part_start, 0x1e3, 5, options);
		} else if (fs_type == 2) {
			write_pbr_data(disk, part_start, 0, 3, grldr_pbr);
			write_pbr_data(disk, part_start, 0x5a, 0x200 - 0x5a, grldr_pbr + 0x5a);
			write_pbr_data(disk, part_start, 0x1e3, 5, options);
		} else if (fs_type == 3) {
			write_pbr_data(disk, part_start, 0, 3, grldr_pbr + 0x800);
			write_pbr_data(disk, part_start, 0x78, 0x400 - 0x78, grldr_pbr + 0x800 + 0x78);
			write_pbr_data(disk, part_start, 0x1e3, 5, options);
			update_exfat_checksum(disk, part_start);
		} else if (fs_type == 4) {
			write_pbr_data(disk, part_start, 0, 3, grldr_pbr + 0xc00);
			write_pbr_data(disk, part_start, 0x54, 0x800 - 0x54, grldr_pbr + 0xc00 + 0x54);
			write_pbr_data(disk, part_start, 0x1e3, 5, options);
		}
	} else {
		return fbfs_set_error(FBFS_ERR_INVALID_ARGUMENT, "unsupported PBR type %s (supported: bootmgr, ntldr, grub4dos)", type);
	}
...
int fbfs_query_mbr(struct fbfs_disk *disk, char *type_name, size_t max_len)
{
	...
	if (is_empty) name = "Empty MBR";
	else if (!memcmp(sector + 0x1b4, "FBBF", 4)) name = "fbinst";
	else if (!memcmp(sector + 0xa7, "\x47\x52\x55\xaa", 4)) name = "GRUB4DOS";
	else if (!memcmp(sector + 0x4f, grldr_gpt + 0x4f, 17)) name = "GRUB4DOS (GPT)";
	else if (!memcmp(sector + 0x180, "GRUB ", 5)) name = "GRUB2";
	else if (!memcmp(sector + 0x5d, "PLoP Boot Manager", 17)) name = "PLoP Boot Manager";
	else if (!memcmp(sector + 0x190, "\x56\x54\x00\x47\x65\x00\x48\x44\x00", 9)) name = "Ventoy";
	else if (!memcmp(sector + 0x1b1, "wee", 3)) name = "WEE";
	else if (!memcmp(sector + 0x110, "XORBOOT", 7)) name = "XorBoot";
	else if (!memcmp(sector, nt5_mbr, 440)) name = "Windows NT 5.x MBR";
	else if (!memcmp(sector, nt6_mbr, 440)) name = "Windows NT 6.x MBR";
	else if (!memcmp(sector, syslinux_mbr, 440)) name = "Syslinux MBR";
	else if (!memcmp(sector, syslinux_gpt_mbr, 440)) name = "Syslinux GPT MBR";
	else if (!memcmp(sector, rufus_mbr, 440)) name = "Rufus Custom MBR";
	else if (!memcmp(sector, ultraiso_hdd, 440)) name = "UltraISO USB-HDD+ MBR";

	snprintf(type_name, max_len, "%s", name);
	return FBFS_OK;
}
...
int fbfs_query_pbr(struct fbfs_disk *disk, uint32_t slot, char *type_name, size_t max_len)
{
	...
	if (fbfs_disk_read(disk, part_start, sector, 1) != FBFS_OK)
		return FBFS_ERR_READ;

	const char *name = "Unknown";
	
	if (!memcmp(sector + 0x1ae, "BOOTMGR", 7)) name = "BOOTMGR (FAT16)";
	else if (!memcmp(sector + 0x16d, "BOOTMGR", 7)) name = "BOOTMGR (FAT32)";
	else if (!memcmp(sector + 0x15e, "\x42\x00\x4F\x00\x4F\x00\x54\x00\x4D\x00\x47\x00\x52\x00", 14)) name = "BOOTMGR (exFAT)";
	else if (!memcmp(sector + 0x1a9, "BOOTMGR", 7)) name = "BOOTMGR (NTFS)";
	else if (!memcmp(sector + 0x1ae, "NTLDR", 5)) name = "NTLDR (FAT16/FAT32)";
	else if (!memcmp(sector + 0x1a2, "NTLDR", 5)) name = "NTLDR (NTFS)";
	else if (!memcmp(sector + 0x1c0, "No ", 3)) name = "GRUB4DOS";
	else if (!memcmp(sector + 0x1bd, "No ", 3)) name = "GRUB4DOS (0.4.5c)";
	else if (!memcmp(sector + 0x1e0, "No ", 3)) name = "GRUB4DOS";
